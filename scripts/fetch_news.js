...
|--------------------------------------------------------------------------
| نکته: برای «جم» فعلاً از booshehr24.ir (پوشش کل استان بوشهر) استفاده
| می‌شه، چون jonoubostan.ir نتیجه نداد. اگه صفحه واقعا RSS نباشه، پارسر
| خودش می‌افته روی حالت HTML-scraping (پایین‌تر توضیح داده شده). بعد از
| هر اجرا (workflow_dispatch) لاگ رو چک کن: اگه یه منبع "Found 0 items"
| داد یا "SOURCE FAILED" داد، بگو تا دقیق‌ترش کنیم.
|--------------------------------------------------------------------------
*/

const FEEDS = [
  {
    name: "بوشهر24 (booshehr24)",
    url: "https://booshehr24.ir/",
    section: "jam",
...
const jamStrongKeywords = [
  ...
  "سیراف",
  "شهرستان دیر",
  // نکته: خودِ "دیر" به‌تنهایی اینجا نیست چون substring کلمه‌ی پرکاربرد
  // "دیروز" است و تقریباً هر خبری رو به‌غلط جم تشخیص می‌داد
];

const jamBlockedKeywords = [
  // شهرهای دیگه استان بوشهر (چون booshehr24 کل استان رو پوشش می‌ده)
  "بوشهر",
  "بندر بوشهر",
  "برازجان",
  "دشتستان",
...
async function main() {
  ...
  console.log("========================================");
  console.log("");
  console.log("۴ منبع اختصاصی: jam=booshehr24 | economic=parseek | world=shahrekhabar | jobs=bazarekar");
