...
/*
|--------------------------------------------------------------------------
| ECONOMIC Keywords (گسترده و کامل)
|--------------------------------------------------------------------------
*/
...
/*
|--------------------------------------------------------------------------
| تشخیص دسته (نسخه اصلاح شده نهایی)
|--------------------------------------------------------------------------
*/
...
function detectSection(title, summary, defaultSection, sourceType) {
  ...
  */
  ...
  // منابع جهانی مستقیماً WORLD می‌شوند
  if (sourceType === "world") {
    return "world";
  }
  ...
  */
  ...
  /*
  ---------------------------------------------------------
  5. رد اخبار سیاسی عمومی (برای جلوگیری از ورود به ECONOMIC)
  ---------------------------------------------------------
  */

  // اگر خبر سیاسی داشت، رد شود (حتی اگر کلمات اقتصادی هم داشته باشد)
  // این باعث می‌شود اخبار سیاسی وارد ECONOMIC نشوند
  ...
  /*
  ---------------------------------------------------------
  6. Fallback برای منابع خاص
  ---------------------------------------------------------
  */

  // منابع جنوبی: اگر JAM نباشند، رد می‌شوند
  if (sourceType === "south") {
    return null;
  }

  // منابع ایرانی: فقط اگر کلمات اقتصادی داشتند (که قبلاً بررسی شد)
  if (sourceType === "iran") {
    return null;
  }
