...
export default function HomeReferralPlacement() {
  ...
  return createPortal(
    <a
      ...
      className="absolute left-6 top-2 z-[1300] flex min-h-[42px] w-[255px] max-w-[42%] items-center gap-2 rounded-2xl border border-[#E8D39A] bg-gradient-to-l from-[#FFF8DD] via-white to-[#FBEEDA] px-2.5 py-1.5 transition hover:-translate-y-0.5 sm:left-6 sm:top-2 sm:w-[265px] sm:max-w-[41%] sm:px-2.5 sm:py-1.5 referral-sun-glow"
    >
