...
export const SUBSCRIPTION_TIERS = [
  {
    ...
    perks: [
      "⭐ درج در ویترین طلایی صفحه اصلی سایت",
      "📢 انتشار روزانه یک آگهی تبلیغاتی در دیوار شهر جم",
      "🏷️ درج در منوی تخفیف‌ها",
      "🔥 درج در منوی محبوب‌ها",
      "⭐ نمایش ویژه کسب‌وکار با نشان طلایی",
      "🏬 مدیریت کامل منو و محصولات",
      "📍 درج در نقشه شهر جم",
      "🎬 ساخت و انتشار کلیپ تبلیغاتی در اینستاگرام jamapp.ir",
    ],
  },
  {
    value: "silver",
