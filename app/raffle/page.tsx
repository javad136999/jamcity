...
export default function RafflePage() {
  ...
  async function doSpin() {
    ...
    // refresh segments so prize availability reflects other players' spins
    ...
    setTimeout(async () => {
      ...
      if (seg.type === "prize" && seg.is_available) {
        // conditional update: only succeeds if still available (race-safe)
        ...
        if (updated && updated.length > 0) {
          ...
          label = "پوچ"; // someone else won it a split second earlier
        }
      }
